...
​O pacote `ConR` [Dalby & Lima, 2023](https://gdauby.github.io/ConR/) para <i class="fab fa-r-project" style="color:blue"> é uma ferramenta desenvolvida para auxiliar na avaliação preliminar do status de conservação de espécies, seguindo os critérios da Lista Vermelha da IUCN. 
